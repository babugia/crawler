...
var Crawler = {
	...
	init : function(){
		...
		Crawler.getPlayersOverview();
	},
    getPlayersOverview(){

        // console.log(link);
        // sleep(001);
        Crawler.request('https://www.hltv.org//stats/players/695/allu?matchType=BigEvents&event=1882', function(err, res, body){
			if(err)
				console.log('Error: ' + err);
            var $ = Crawler.cheerio.load(body);
            
            const link = 'https://www.hltv.org//stats/players/695/allu?matchType=BigEvents&event=1882';
