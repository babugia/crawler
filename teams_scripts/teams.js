...
var Crawler = {
    ...
    getTeamsFtu(link, event_id) {
        ...
        //     })
           ...
           Crawler.getTeamsPistol('https://www.hltv.org/'+pistolLink, event_id);
		});
    },
    getTeamsPistol(link, event_id) {
        sleep(80);
        Crawler.request(link, function(err, res, body){
			if(err)
				console.log('Error: ' + err);
